...
Neste caso, um erro é exibido pois o pacote **dplyr** não está instalado ou carregado. Caso ele já estiver instalado, a mensagem de erro acima é superada ao carregar o pacote antes de rodar a função.
...
library(pacman)
p_load(hnp, asbio, car, dplyr, emmeans, effects, multcomp, lme4, readxl,
       ExpDes, manipulate, cowplot, tidyverse, agricolae, psych, corrplot,
       pvclust, factoextra, kableExtra, ggfortify)

p_load_gh("TiagoOlivoto/metan")
```
