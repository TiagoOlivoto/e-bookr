...
- Crie uma função chamada `mega` que retorna os números a serem apostados em jogo simples da Mega Sena, tendo como um único argumento `jogos`, que define quantos jogos de 6 números devem ser criados. Para cada jogo ordene os números em ordem crescente.
