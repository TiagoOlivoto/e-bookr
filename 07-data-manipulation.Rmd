...
* `all_lower_case()`: converte todas as seqüências não numéricas de um conjunto de dados para minúsculas ("Env" para "env"). \indf{all\_lower\_case}
* `all_upper_case()`: converte todas as seqüências não numéricas de um conjunto de dados para maiúsculas (por exemplo, "Env" para "ENV").\indf{all\_upper\_case}
* `all_title_case()`: converta todas as seqüências não numéricas de um conjunto de dados em maiúsculas e minúsculas (por exemplo, "ENV" para "Env").\indf{all\_title\_case}
